...
def repeatedNew(f, n):
    ...
    >>> add_three = repeatedNew(increment, 3)
    >>> add_three(5)
    8
    >>> repeatedNew(triple, 5)(1) # 3 * 3 * 3 * 3 * 3 * 1
    243
    >>> repeatedNew(square, 2)(5) # square(square(5))
    625
    >>> repeatedNew(square, 4)(5) # square(square(square(square(5))))
    152587890625
    >>> repeatedNew(square, 0)(5)
    5
    """
